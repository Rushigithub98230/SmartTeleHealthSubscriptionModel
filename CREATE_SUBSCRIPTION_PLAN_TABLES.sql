-- =====================================================
-- CREATE SUBSCRIPTION PLAN RELATED TABLES
-- =====================================================
-- This script creates all subscription plan related tables
...
-- =====================================================
SELECT 'Verifying tables are created...' as Status;
...
SELECT 'All subscription plan related tables have been created successfully!' as Result;
