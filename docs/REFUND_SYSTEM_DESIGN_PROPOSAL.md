...
Calculation:
  monthsInCycle = 365 days / 30 = 12.17 months
  Total in Cycle = 10 × 12.17 = 121.7 → rounds up to 122 consultations
  
50% Threshold: 61 consultations
Eligible if Used < 61

⚠️ CRITICAL: Annual plan privileges reset ONCE per year (not monthly!)
User gets 122 consultations for THE FULL YEAR
Refund calculated against full year allocation, not monthly pro-rated
```

---

## 🔄 **CRITICAL: BILLING CYCLE & RESET FREQUENCY**

### **Understanding Reset Behavior (Affects Refund Calculation)**

```
┌─────────────────────────────────────────────────────────────┐
│ MONTHLY BILLING - FREQUENT RESETS                          │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│ Payment: $150/month                                         │
│ Allocation: 10 consultations                                │
│ Reset: EVERY MONTH (when payment occurs)                    │
│                                                             │
│ Timeline Example:                                           │
│   Jan 2025: Pay $150 → Get 10 consultations                │
│   Feb 2025: Pay $150 → RESET → Get fresh 10 consultations  │
│   Mar 2025: Pay $150 → RESET → Get fresh 10 consultations  │
│   ...                                                       │
│   Dec 2025: Pay $150 → RESET → Get fresh 10 consultations  │
│                                                             │
│ REFUND IMPLICATION:                                         │
│   If user requests refund in May:                           │
│   - Only calculate against MAY's allocation (10)            │
│   - Jan-Apr already paid and consumed (separate cycles)     │
│   - Refund only for current month's unused portion          │
│                                                             │
└─────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────┐
│ ANNUAL BILLING - SINGLE RESET                              │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│ Payment: $1,530/year (ONCE)                                 │
│ Allocation: 122 consultations FOR ENTIRE YEAR               │
│ Reset: ONCE PER YEAR (when annual payment occurs)           │
│                                                             │
│ Timeline Example:                                           │
│   Jan 1, 2025: Pay $1,530 → Get 122 consultations          │
│   Feb 2025: NO payment, NO reset (still have from 122)      │
│   Mar 2025: NO payment, NO reset (still have from 122)      │
│   Apr 2025: NO payment, NO reset (still have from 122)      │
│   ...                                                       │
│   Dec 2025: NO payment, NO reset (still have from 122)      │
│   Jan 1, 2026: Pay $1,530 → RESET → Get fresh 122          │
│                                                             │
│ REFUND IMPLICATION:                                         │
│   If user requests refund in May (5 months in):             │
│   - Calculate against FULL YEAR allocation (122)            │
│   - Used 50 consultations: 50/122 = 40.98% < 50% ✅        │
│   - Refund based on FULL annual payment ($1,530)            │
│   - DON'T pro-rate by months! User paid upfront for year.  │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
```csharp
// From PrivilegeService.cs Lines 1215-1224
var billingCycleDays = subscription.BillingCycle.DurationInDays;
var monthsInCycle = billingCycleDays / 30.0m;

// Examples:
// Monthly: 30 days / 30 = 1.0 month
// Quarterly: 90 days / 30 = 3.0 months
// Yearly: 365 days / 30 = 12.17 months ✅
...
// Examples:
// Monthly: Ceiling(10 × 1.0) = 10 consultations
// Quarterly: Ceiling(10 × 3.0) = 30 consultations
// Yearly: Ceiling(10 × 12.17) = Ceiling(121.7) = 122 consultations ✅

// Period boundaries (determines when reset happens):
periodStart = subscription.LastBillingDate?.AddDays(1) ?? subscription.StartDate;
periodEnd = subscription.NextBillingDate;

// For annual plan: NextBillingDate = StartDate + 365 days
// Privileges DON'T reset until NextBillingDate arrives!
```

### **Why This Matters for Refunds:**

```
CORRECT REFUND APPROACH:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Monthly Plan Refund:
  - Look at CURRENT billing cycle only
  - Allocation: 10 consultations
  - Period: Current month (30 days)
  - Refund base: Current month's payment ($150)

Annual Plan Refund:
  - Look at FULL YEAR billing cycle
  - Allocation: 122 consultations (full year)
  - Period: Full year (365 days)
  - Refund base: Full annual payment ($1,530)
  
⚠️ DON'T calculate annual refund as "5 months × monthly rate"!
User paid UPFRONT for full year, gets refund based on FULL year allocation.
```
...
### **Example 3: Annual Plan - Eligible After 5 Months** ✅
...
Months in Cycle: 365 / 30 = 12.17 months

Monthly Privilege Limits:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Privilege          | Monthly | Unit Cost | Monthly Cost
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Teleconsultation   |   10    |   $12     |   $120
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Annual Allocation (FULL YEAR):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Privilege          | Annual Calc          | Annual Limit | Annual Cost
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Teleconsultation   | Ceiling(10 × 12.17) |    122       |   $1,464
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TOTAL PRIVILEGE COST:                                    $1,464

Admin Commission (FIXED):                                   $66
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TOTAL SUBSCRIPTION FEE:                                $1,530

Payment Schedule:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Jan 1, 2025: Pay $1,530 → Get 122 consultations for FULL YEAR
Feb-Dec 2025: NO payments, NO resets
Jan 1, 2026: Pay $1,530 → RESET → Get fresh 122 consultations

⚠️ Reset Frequency: ONCE per year (not monthly!)

═══════════════════════════════════════════════════════════════
USER REQUESTS REFUND (May 2025 - After 5 months)
═══════════════════════════════════════════════════════════════
Time Elapsed: 5 months into annual subscription
Privilege Usage:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Privilege          | Annual Limit | Used | Remaining
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Teleconsultation   |     122      |  50  |    72
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Overall Usage: 50 / 122 = 40.98% < 50% ✅ ELIGIBLE

⚠️ IMPORTANT: Calculate against FULL YEAR (122), not monthly!
Even though user is 5 months in, they paid for FULL YEAR upfront.

═══════════════════════════════════════════════════════════════
REFUND CALCULATION
═══════════════════════════════════════════════════════════════

1. Used Privilege Cost:
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Teleconsultation: 50 × $12 = $600

2. Total Privilege Cost (FULL YEAR): $1,464

3. Refund Calculation:
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Refund = Total Annual Privilege Cost - Used Privilege Cost
   Refund = $1,464 - $600
   Refund = $864 ✅

4. Admin Commission:
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Admin Commission: $66 (PLATFORM KEEPS - NOT REFUNDED) ❌

═══════════════════════════════════════════════════════════════
FINAL SUMMARY
═══════════════════════════════════════════════════════════════
User Paid (Jan 1, 2025):  $1,530 (FULL YEAR UPFRONT)

Platform Keeps:
  - Used Privileges (50 consultations): $600
  - Admin Commission: $66 (NON-REFUNDABLE)
  - Total Kept: $666

User Refunded (May 2025): $864

Verification: $666 + $864 = $1,530 ✅ CORRECT

Key Points:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ User paid ONCE for full year ($1,530)
✅ User got 122 consultations for FULL YEAR
✅ Used 50 after 5 months (40.98% usage)
✅ Refund calculated against ANNUAL allocation (not monthly × 5)
✅ This prevents revenue loss and is fair to platform
✅ User still gets back unused portion ($864 worth of services)
```

---

### **Example 4: Monthly Plan - NOT Eligible**
...
### **Example 5: Edge Case - Exactly 50% Usage**
