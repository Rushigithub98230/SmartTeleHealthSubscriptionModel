...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<SubscriptionPlan, SubscriptionPlanDto>()
            ...
            .ForMember(dest => dest.BillingCycleName, opt => opt.MapFrom(src => src.BillingCycle.Name))
            .ForMember(dest => dest.BillingCycleDescription, opt => opt.MapFrom(src => src.BillingCycle.Description))
            .ForMember(dest => dest.BillingCycleDurationInDays, opt => opt.MapFrom(src => src.BillingCycle.DurationInDays))
        ...
        CreateMap<UpdateSubscriptionPlanDto, SubscriptionPlan>()
            ...
            .ForMember(dest => dest.IsTrending, opt => opt.MapFrom(src => src.IsTrending))
            .ForMember(dest => dest.DisplayOrder, opt => opt.MapFrom(src => src.DisplayOrder))
            .ForMember(dest => dest.IsAutoCalculatedPrice, opt => opt.MapFrom(src => src.IsAutoCalculatedPrice))
            .ForMember(dest => dest.AdminCommissionPercent, opt => opt.MapFrom(src => src.AdminCommissionPercent))
            .ForMember(dest => dest.PriceChangeNoticeDays, opt => opt.MapFrom(src => src.PriceChangeNoticeDays))
            .ForMember(dest => dest.BillingDiscountPercentage, opt => opt.MapFrom(src => src.BillingDiscountPercentage))
            .ForMember(dest => dest.UpdatedDate, opt => opt.MapFrom(src => DateTime.UtcNow));
